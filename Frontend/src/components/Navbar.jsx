            ...
            <div className="collapse navbar-collapse mobile-menu-dropdown" id="mainNavbar">
              ...
              {token ? (
                <>
                  <ul className="navbar-nav mx-auto mb-2 mb-lg-0 fw-medium text-start mt-2 mt-lg-0 px-2 px-lg-0">
                    ...
                    <li className="nav-item">
                      <a className={`nav-link mobile-nav-link `} href="/our-team">Team</a>
                    </li>
                    <li className="nav-item">
                  ...
                  <div className="d-none d-lg-block vr mx-3 text-secondary opacity-25" style={{ minHeight: '30px' }}></div>
              ...
              <div className="d-flex flex-column flex-lg-row align-items-lg-center gap-3 mt-2 mt-lg-0 pb-2 pb-lg-0 me-lg-2 px-2 px-lg-0 text-center text-lg-start">
                ...
                <button
                  ...
                  className="btn btn-link text-decoration-none rounded-circle p-0 d-flex align-items-center  text-center justify-content-center me-lg-2"
                  style={{ width: '40px', height: '40px', margin: 'auto' }}
                  aria-label="Toggle Dark Mode"
                >
                  {isDarkMode ? (
                    <i className="fa-solid fa-sun fs-5 light-mode"></i>
                  ) : (
